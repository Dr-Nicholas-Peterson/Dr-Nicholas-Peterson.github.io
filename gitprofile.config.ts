...
const CONFIG = {
  github: {
    username: 'Dr-Nicholas-Peterson', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['Dr-Nicholas-Peterson/Bioinformatics'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
